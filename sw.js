const CURRENT_CACHE = 'peakslab-0.5.6.4';   // ← Bump this on every deploy!
...
const FILE_VERSIONS = {
  ...
  '/khmer/db/kmULB.peak.zst': 'v5',
  '/khmer/db/khsv.peak.zst': 'v2',
  '/khmer/db/khov.peak.zst': 'v2',
  ...
  '/khmer/db/kora.slab': 'v2',
  '/khmer/manifest.json': 'v2',

  '/khmermusic/config.js': 'v3',
  '/khmermusic/': 'v2',
  ...
  '/german/db/deuSchBible.peak.zst': 'v2',
  ...
  '/english/db/eng-bsb.peak.zst': 'v3',
  '/english/db/eng-kjv.peak.zst': 'v3',
  '/english/db/engULB.peak.zst': 'v3',
  ...
  '/chitonga/db/toibible.peak.zst': 'v3',
